...
- Add CI lint coverage for Rust, CloudFormation, Python custom resources, dependency policy, and infrastructure checks.
...
- Update dependencies to fix security vulnerabilities
  - `github.com/coralogix/coralogix-aws-shipper/security/dependabot/7`
...
- Update dependencies to fix security vulnerabilities
  - `github.com/coralogix/coralogix-aws-shipper/security/dependabot/2`
