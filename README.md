...
!!! Tip  
    ...
    If you need to add multiple log groups to the lambda function using regex, please refer to our [lambda manager](https://github.com/coralogix/coralogix-aws-serverless/tree/master/src/lambda-manager#coralogix-lambda-manager)
...
This workflow is designed for scenarios where you need to stream CloudWatch Metrics to Coralogix through a PrivateLink endpoint.
