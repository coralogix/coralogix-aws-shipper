...
| CoralogixRegion | The Coralogix location region, possible options are [Custom, EU1, Eu2, AP1, AP2, US, US2] [Coralogix Regions](https://coralogix.com/docs/coralogix-domain/) If this value is set to Custom you must specify the Custom Domain to use via the CustomDomain parameter |  Custom | :heavy_check_mark: | 
